...
export default function ImageDisplay(props: Props) {
  ...
  return (
    <div
      class="relative w-screen h-full flex justify-center items-center overflow-hidden bg-white text-black dark:bg-black dark:text-white cursor-default select-none lg:px-[160px]"
      onClick={props.onTap}
    >
