...
export default function HistoryModal(props: Props) {
  return (
    <div class="absolute top-10 left-1/2 -translate-x-1/2 bg-white dark:bg-black border border-zinc-600 rounded-lg shadow-lg z-50 max-w-3xl w-full max-h-[80vh] overflow-y-auto p-4">
