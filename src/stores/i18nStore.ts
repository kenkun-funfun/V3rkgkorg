...
export const i18n = {
    ja: {
        ...
        wait_max_plays: '再生枚数',
        wait_enable_shuffle: 'シャッフル再生を有効にする',
        wait_enable_keyboard: 'キーボード操作を有効にする',
        wait_enable_tap: 'タップ操作を有効にする',
        minutes: '分',
        seconds: '秒',
        ...
        delete_cancel: 'キャンセル',
        delete_confirm: '削除する',
        image_display_unavailable: '画像を表示できません',
    ...
    en: {
        ...
        play_paused: 'Paused',
        play_back_to_play: 'Back to Playback',
        ...
        image_display_unavailable: 'Image not available',
